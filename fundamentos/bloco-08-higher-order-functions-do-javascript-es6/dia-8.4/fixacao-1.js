...
const melhoresNotas = (acc, materia) => {
...
const relatorioMelhoresNotas = (arrayStudants) => arrayStudants.map((arrayStudant) => ({
  name: arrayStudant.nome, materia: arrayStudant.materias.reduce(melhoresNotas).name,
}));
